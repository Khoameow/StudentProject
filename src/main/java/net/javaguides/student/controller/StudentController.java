...
public class StudentController {
	...
	@RequestMapping("/download/student.csv")
	public void downloadCSVFile(HttpServletResponse response) throws IOException{
		...
		csvStudent.downloadCSVFile(response.getWriter(), studentService.getAllStudents());
	}
	public List<Student>createDataTest(){
